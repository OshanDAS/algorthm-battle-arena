...
public class StudentOnlyAttributeTests
{
    ...
    public void OnAuthorization_UnauthenticatedUser_ReturnsForbidden()
    {
        ...
        // Note: Same bug as AdminOnlyAttribute - should return UnauthorizedResult
        Assert.IsType<ForbidResult>(context.Result);
    }

    [Fact]
    public void OnAuthorization_AuthenticatedNonStudentUser_ReturnsForbidden()
    {
        var attribute = new StudentOnlyAttribute();
    ...
    [Fact]
    public void OnAuthorization_AuthenticatedUserWithAdminRole_ReturnsForbidden()
    {
        var attribute = new StudentOnlyAttribute();
