...
import { BarChart, User, Users, Trophy, Swords, PlayCircle, LogOut, TrendingUp, UserPlus, Calendar, Settings, Home, Medal } from 'lucide-react';
    ...
    switch (activeTab) {
      ...
      case 'friends':
        return (
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-white">Friends</h3>
              <div className="space-y-3">
                <FriendListItem name="Alice Johnson" online={true} />
                <FriendListItem name="Bob Smith" online={false} />
                <FriendListItem name="Charlie Brown" online={true} />
                <FriendListItem name="David Wilson" online={false} />
              </div>
              <button className="mt-4 w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-lg">
                Add Friends
              </button>
            </div>
